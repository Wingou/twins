			...
			[
				...
				_List_fromArray(
					[
						...
						$joakin$elm_canvas$Canvas$Settings$Line$lineWidth(15)
					]),
				_List_fromArray(
					[
						A2(
						$joakin$elm_canvas$Canvas$circle,
						_Utils_Tuple2(220, 220),
						360)
					])),
				A2(
				$joakin$elm_canvas$Canvas$shapes,
				...
				_List_fromArray(
					[
						...
						$joakin$elm_canvas$Canvas$Settings$Line$lineWidth(10)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$joakin$elm_canvas$Canvas$lineTo(
								_Utils_Tuple2(320, 520)),
								$joakin$elm_canvas$Canvas$lineTo(
								_Utils_Tuple2(360, 520)),
								$joakin$elm_canvas$Canvas$lineTo(
								_Utils_Tuple2(380, 500)),
								$joakin$elm_canvas$Canvas$lineTo(
								_Utils_Tuple2(380, 300)),
								$joakin$elm_canvas$Canvas$lineTo(
								_Utils_Tuple2(300, 300))
